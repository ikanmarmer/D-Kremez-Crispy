...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Register your Filament PanelProvider classes here. Panel providers are
    | used to register panels, navigation, pages, and other panel-specific
    | services. Add your provider (for example App\Providers\Filament\AdminPanelProvider::class)
    | to enable your custom panel resources.
    |
    */
    'providers' => [
